...
class bendaharaGajiPegawaiController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pages.bendahara.gajipegawai.index', compact('datas', 'request', 'pages', 'cari', 'getsettingsgaji'));
    }
    ...
    public function cetak(Request $request)
    {
        ...
        $getsettingsgaji = settingsgaji::first();
        $tgl = date("YmdHis");
        $pdf = PDF::loadview('pages.bendahara.gajipegawai.cetak', compact('datas', 'getsettingsgaji', 'tgl', 'year', 'month'))->setPaper('a4', 'landscape');
    ...
    public function cetakperid(gajipegawai $id, Request $request, $cari = null)
    {
        ...
        $getsettingsgaji = settingsgaji::first();
        $tgl = date("YmdHis");
        $pdf = PDF::loadview('pages.bendahara.gajipegawai.cetakperid', compact('datas', 'getsettingsgaji', 'tgl', 'year', 'month'))->setPaper('a4', 'landscape');
        return $pdf->stream('hrpegawai' . $tgl . '-pdf');
    }
    ...
    public function create()
    {
        $pages = 'pegawai';
        $items = jabatan::get();
        return view('pages.bendahara.pegawai.create', compact('pages', 'items'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('bendahara.pegawai')->with('status', 'Data berhasil tambahkan!')->with('tipe', 'success')->with('icon', 'fas fa-feather');
    }
    ...
    public function edit(gajipegawai $id)
    {
        ...
        return view('pages.bendahara.gajipegawai.edit', compact('pages', 'id', 'items'));
    }
    public function update(gajipegawai $id, Request $request)
    {
        ...
        return redirect()->route('bendahara.gajipegawai')->with('status', 'Data berhasil diubah!')->with('tipe', 'success')->with('icon', 'fas fa-feather');
    }
