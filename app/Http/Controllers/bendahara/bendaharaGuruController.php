...
class bendaharaGuruController extends Controller
{
    ...
    public function cari(Request $request)
    {
        ...
        return view('pages.bendahara.guru.index', compact('datas', 'request', 'pages'));
    }
    public function create()
    {
        $pages = 'guru';
        $items = jabatan::get();
        return view('pages.bendahara.guru.create', compact('pages', 'items'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('bendahara.guru')->with('status', 'Data berhasil tambahkan!')->with('tipe', 'success')->with('icon', 'fas fa-feather');
    }
    ...
    public function edit(guru $id)
    {
        ...
        return view('pages.bendahara.guru.edit', compact('pages', 'id', 'items'));
    }
    public function update(guru $id, Request $request)
    {
        ...
        return redirect()->route('bendahara.guru')->with('status', 'Data berhasil diubah!')->with('tipe', 'success')->with('icon', 'fas fa-feather');
    }
    public function destroy(guru $id)
    {
        ...
        return redirect()->route('bendahara.guru')->with('status', 'Data berhasil dihapus!')->with('tipe', 'warning')->with('icon', 'fas fa-feather');
    }
}
