...
class bendaharaPegawaiController extends Controller
{
    ...
    public function edit(pegawai $id)
    {
        ...
        return view('pages.bendahara.pegawai.edit', compact('pages', 'id', 'items'));
    }
    public function update(pegawai $id, Request $request)
    {
        ...
        return redirect()->route('bendahara.pegawai')->with('status', 'Data berhasil diubah!')->with('tipe', 'success')->with('icon', 'fas fa-feather');
    }
    public function destroy(pegawai $id)
    {
        ...
        return redirect()->route('bendahara.pegawai')->with('status', 'Data berhasil dihapus!')->with('tipe', 'warning')->with('icon', 'fas fa-feather');
    }
}
