        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form  action="{{route('gajiguru.update',$id->id)}}" method="post" >
                            @method('put')
                            @csrf
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control"
                                        name="nama" id="nama"   value="{{old('nama')?old('nama'):$id->guru->nama}}" readonly />
                                </div>
                            </div>
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    name="nomerinduk" id="nomerinduk"   value="{{old('nomerinduk')?old('nomerinduk'):$id->guru->nomerinduk}}" readonly/>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    @enderror" name="jabatan[]"  style="width: 100%" multiple="multiple"  disabled>
                                        ...
                                        @php
                                            $periksa=\App\Models\gurudetail::where('guru_id',$id->guru_id)->where('jabatan_id',$item->id)->count();
                                        @endphp
