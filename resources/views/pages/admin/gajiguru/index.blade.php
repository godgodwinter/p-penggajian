    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <form action="{{ route('gajiguru') }}" method="get" class="d-inline">
                        ...
                        @if ($datas->count() > 0)
                            ...
                            <form action="{{ route('gajiguru.cetak') }}" method="get" class="d-inline">
                                @csrf
                                <input type="hidden" name="cari" value="{{ $cari }}">
                                <input class="btn btn-info ml-1 mt-2 mt-sm-0" type="submit" id="babeng-submit"
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                {{-- <th class="text-center" data-toggle="tooltip" data-placement="top"
                                                    title="{{ Fungsi::rupiah($getsettingsgaji->dansos) }}">Jumlah Diterima
                                                </th> --}}
                                                ...
                                                <tr>
                                                    ...
                                                    {{-- <td class="text-center">
                                                        @php
                                                            $jumlah_diterima = '-';
                                                            $jml_diterima = 0;
                                                            $jml_diterima += $data->tunjanganjabatan + $data->tunjangankerja + $data->transport * $data->hadir + $data->gajipokok * $data->jam;
                                                        @endphp
                                                    ...
                                                    <td class="babeng-min-row">
                                                        ...
                                                        <x-button-delete
                                                            link="{{ route('gajiguru.destroy', $data->id) }}" />
                                                    </td>
                                                </tr>
                                            @empty
                                            @endforelse
