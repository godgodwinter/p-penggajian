            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <a class="btn btn-sm btn-primary" href="{{ route('kepsek.create') }}"> Tambah </a>
                                            ...
                                            @forelse ($datas as $data)
                                                <tr>
                                                    ...
                                                    <td class="babeng-min-row">
                                                        <x-button-edit link="{{ route('kepsek.edit', $data->id) }}" />
                                                        <x-button-delete link="{{ route('kepsek.destroy', $data->id) }}" />
                                                    </td>
                                                </tr>
                                            @empty
                                            @endforelse
