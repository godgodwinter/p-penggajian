        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="{{ route('bendahara.gajipegawai.update', $id->id) }}" method="post">
                            @method('put')
                            @csrf
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" name="nama" id="nama"
                                        value="{{ old('nama') ? old('nama') : $id->pegawai->nama }}" readonly />
                                </div>
                            </div>
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control  @error('nomerinduk') is-invalid @enderror" name="nomerinduk"
                                        id="nomerinduk"
                                        value="{{ old('nomerinduk') ? old('nomerinduk') : $id->pegawai->nomerinduk }}"
                                        readonly />
                                    @error('nomerinduk')
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    @enderror"
                                        ...
                                        @foreach ($items as $item)
                                            @php
                                                $periksa = \App\Models\pegawaidetail::where('pegawai_id', $id->pegawai_id)
