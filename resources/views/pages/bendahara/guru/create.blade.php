        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="{{ route('bendahara.guru.store') }}" method="post">
                            @csrf
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control  @error('nama') is-invalid @enderror" name="nama"
                                        id="nama" required="required" value="{{ old('nama') }}" />
                                    @error('nama')
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control  @error('nomerinduk') is-invalid @enderror" name="nomerinduk"
                                        id="nomerinduk" required="required" value="{{ old('nomerinduk') }}" />
                                    @error('nomerinduk')
                                        <div class="invalid-feedback"> {{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control  @error('hadir') is-invalid @enderror" name="hadir"
                                        id="hadir" type="number" min="0" required="required"
                                        value="{{ old('hadir') }}" />
                                    @error('hadir')
                                        <div class="invalid-feedback"> {{ $message }}</div>
                                    @enderror
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control  @error('jam') is-invalid @enderror" name="jam"
                                        id="jam" type="number" min="0" required="required"
                                        value="{{ old('jam') }}" />
                                    @error('jam')
                                        <div class="invalid-feedback"> {{ $message }}</div>
                                    @enderror
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control  @error('alamat') is-invalid @enderror" name="alamat"
                                        id="alamat" required="required" value="{{ old('alamat') }}" />
                                    @error('alamat')
                                        <div class="invalid-feedback"> {{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control  @error('telp') is-invalid @enderror" name="telp"
                                        id="telp" type="text" required="required" value="{{ old('telp') }}" />
                                    @error('telp')
                                        <div class="invalid-feedback"> {{ $message }}</div>
                                    @enderror
                                </div>
